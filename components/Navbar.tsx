...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full top-0 z-10 sm:bg-gray-900 sm:bg-opacity-90">
      <div className="container flex flex-wrap justify-between items-center mx-auto max-w-4xl bg-gray-900 px-5 py-5 backdrop-filter backdrop-blur-sm bg-opacity-90 sm:bg-opacity-0 shadow-lg xl:max-w-6xl">
        <Link href="/" passHref>
